// code cloned from "json-socket": "^0.2.1"
// https://github.com/sebastianseilund/node-json-socket/blob/master/lib/json-socket.js
// added `once` method to the prototype
  ...
  _handleData: function (data) {
    ...
    if (this._contentLength == null) {
      ...
      if (i !== -1) {
        ...
        this._contentLength = parseInt(rawContentLength, 10)
